  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "mustafoxalimov12@gmail.com",
      href: "mailto:mustafoxalimov12@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+998 91 544 94 69",
          ...
          >
                ...
                {contactInfo.map((item, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      className="flex items-center gap-4 p-4 bg-card border border-border rounded-xl hover:border-primary/50 hover:bg-card/80 transition-all group"
                    >
            ...
            <div className="p-6 bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 rounded-xl">
              ...
              <p className="text-sm text-muted-foreground">
                I'm currently seeking internship and full-time positions in cybersecurity, 
                full-stack development, and related fields. Let's connect!
              </p>
            </div>
          </motion.div>
